...
import Livetime.Commands.LiveTime;
import Livetime.Commands.LiveWeather;
import Livetime.listeners.BigMoveEvent;
import Livetime.listeners.JoinEvent;
import Livetime.listeners.pTimeEvent;
...
public class Main extends JavaPlugin
{
	...
	public boolean createWeatherPrefsTable()
	{
		...
		try
		{
			...
			if (iCount == 1)
			{
				Bukkit.getConsoleSender().sendMessage(ChatColor.AQUA + "Created new live weather preferences table");			
				bSuccess = true;
			}
		}
		catch(SQLException se)
